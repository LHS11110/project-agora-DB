...
def test_mssql():
    ...
    try:
        ...
        run_query(f"INSERT INTO [{MSSQL_TABLE_USERS}] (email, password_hash, nickname, tag_number, role, status) VALUES ('{test_email}', 'dummy_hash', N'PyTester', 1234, 'ROLE_USER', 'ACTIVE');")
